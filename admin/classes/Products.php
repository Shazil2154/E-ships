<?php 
session_start();
// Agar product add ni ho ra to nechy add product ka fun hai udhr chala ja call mat kri mughy
/**

Agar pta na lg ra ho
...
class Products
{
	...
	// idhr $filename mai koi msla hai
	//jahan image dalty wahan koi msla hai uski fileget hony mai error
	...
	public function addProduct($product_name,
		...
		if ($ext == "jpg" || $ext == "jpeg" || $ext == "png") {
			...
			if ($file['size'] > (1024 * 2)) {
				...
				if (move_uploaded_file($file['tmp_name'], $_SERVER['DOCUMENT_ROOT']."/E-ships/product_images/".$uniqueImageName)) {
